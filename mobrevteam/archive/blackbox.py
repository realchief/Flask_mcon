...
"""This module implements a python connector for the blackbox SMS api
"""
__all__ = ['Blackbox']
...
API_URL = "http://blackbox.co.ke/vas/index.php/api/"
API_SEND_PATH = "send_sms"
API_GET_PATH = "get_balance"
SMS_XML_TEMPLATE = "<sms><recipient>%s</recipient><message>%s</message><sender>%s</sender><keyword>%s</keyword><scheduled_date>%s</scheduled_date></sms>"
...
class Blackbox(object):
    ...
    def queue_sms(self, recipient, message, sender = "", keyword = "", scheduled_date = ""):
        """Add an sms to list of messages to send"""
        self.sms_messages.append(SMS_XML_TEMPLATE % (recipient, message, sender, keyword, scheduled_date))
